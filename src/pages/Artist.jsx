...
export default function Artist() {
    ...
    useEffect(() => {
        if (id) fetchArtistInfo(id), fetchPosts(id);
    }, [id]);

    const goToPostPage = () => {
        navigate("/new-log", { state: { artist: id } });
    };
            ...
            >
                <div className="">
                    <div className="rounded-xl flex flex-col items-center">
                        <img src={artist.image} className=""/>
                        <div className="flex justify-between w-full px-6 py-2">
                            ...
                            <div className="flex flex-col justify-between ">
                                ...
                                <p className="font-semibold text-sm text-white/85">artist</p>
                            </div>
